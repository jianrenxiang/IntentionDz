...
@interface DZHomeTableViewCellFrame ()
@property(nonatomic,assign)BOOL isDetail;
@end

@implementation DZHomeTableViewCellFrame
...
- (void)setModel:(NHHomeServiceDataElement *)model {
    ...
    NSAttributedString *string = [DZUtils attStringWithString:group.content keyWord:nil];
    ...
    if (!self.isDetail) {
        ...
        if (comments.count) {
            for (int i = 0; i < comments.count; i++) {
                ...
                CGFloat commentViewH = 60 + [[DZUtils attStringWithString:comment.text keyWord:nil] heightWithConstrainedWidth:kScreenWidth - 120] + 10;
