...
#import "DZUserInfoModel.h"
typedef NS_ENUM(NSUInteger,DZHomeServiceDataElementMediatype){
//    大图
    DZHomeServiceDataElementMediatypeLargeImage=1,
//    gif
    DZHomeServiceDataElementMediatypeGif=2,
//    视频
    DZHomeServiceDataElementMediatypeVideo=3,
//    小图
    DZHomeServiceDataElementMediatypeLittleImages=4,
//    精华
    DZHomeServiceDataElementMediatypeEssence=5,
};
...
@interface DZHomeServiceDataModel : NHBaseModel
...
/** 数据类型*/
@property (nonatomic, assign) DZHomeServiceDataElementMediatype media_type;
@property (nonatomic, assign) NSInteger type;
@property (nonatomic, assign) NSInteger status;
...
/** 当前数据对应的用户信息*/
@property (nonatomic, strong) DZUserInfoModel *user;
