//
//  DZDynamicDetailCommentTableViewCell.m
//  IntentionDz
//
...
@interface DZDynamicDetailCommentTableViewCell () <UIGestureRecognizerDelegate>
/** 头像*/
...
@end
@implementation DZDynamicDetailCommentTableViewCell
- (void)setCellFrame:(DZDynamicDetailCommentCellFrame *)cellFrame {
