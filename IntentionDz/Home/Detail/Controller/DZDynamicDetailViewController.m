...
#import "WMPlayer.h"
#import "DZHomeAttentionListSectionHeaderView.h"
#import "MJPhotoBrowser.h"
#import "MJPhoto.h"
#import "NHHomeNeiHanShareView.h"
#import "DZBaseNavigationViewController.h"
@interface DZDynamicDetailViewController ()<DZHomeTableViewCellDelegate,NHDynamicDetailCommentTableViewCellDelegate,WMPlayerDelegate>
...
- (void)requestActionWithActionname:(NSString *)actionname {
    ...
    DZHomeTableViewCell *cell = [self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:0]];
    // 指针不变，只需要更换值
...
- (UIView *)nh_headerAtSection:(NSInteger)section {
    ...
    DZHomeAttentionListSectionHeaderView *headerView = [DZHomeAttentionListSectionHeaderView headerFooterViewWithTableView:self.tableView];
...
- (void)homeTableViewCellDidClickCategory:(DZHomeTableViewCell *)cell {
...
- (void)homeTableViewCell:(DZHomeTableViewCell *)cell didClickImageView:(UIImageView *)imageView currentIndex:(NSInteger)currentIndex urls:(NSArray<NSURL *> *)urls {
...
-(void)homeTableViewCell:(DZHomeTableViewCell *)cell didClickItemWithType:(DZHomeTableViewCellItemType)itemType {
...
- (void)homeTableViewCell:(DZBaseTableViewCell *)cell gotoPersonalCenterWithUserInfo:(DZUserInfoModel *)userInfoModel {
