...
@implementation DZCustomAleartView
...
-(void)setUp{
    ...
    [cancel setBackgroundImage:[DZUtils imageWithColor:[[UIColor whiteColor] colorWithAlphaComponent:0.3]] forState:UIControlStateNormal];
    [cancel setBackgroundImage:[DZUtils imageWithColor:[[UIColor lightTextColor] colorWithAlphaComponent:0.3]] forState:UIControlStateHighlighted];
    ...
    [sure setBackgroundImage:[DZUtils imageWithColor:[[UIColor whiteColor] colorWithAlphaComponent:0.3]] forState:UIControlStateNormal];
    [sure setBackgroundImage:[DZUtils imageWithColor:[[UIColor lightTextColor] colorWithAlphaComponent:0.3]] forState:UIControlStateHighlighted];
...
- (void)showInView:(UIView *)view {
    ...
    BOOL isShowing = [DZCustomAleartView alertIsShowingInView:view];
    if (isShowing) return ;
    ...
    [DZAnimationManager addTransformAnimationForView:self.contentView];
