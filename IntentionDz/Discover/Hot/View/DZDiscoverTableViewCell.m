...
@interface DZDiscoverTableViewCell ()
...
@end
@implementation DZDiscoverTableViewCell
- (void)setElementModel:(NHDiscoverCategoryElement *)elementModel {
    _elementModel = elementModel;
    if (elementModel.intro) {
        self.contentL.attributedText = [DZUtils attStringWithString:elementModel.intro keyWord:self.keyWord font:kFont(12) highlightedColor:kCommonHighLightRedColor textColor:kDiscoverTextColor];
    }
    if (elementModel.name) {
        self.nameL.attributedText = [DZUtils attStringWithString:elementModel.name keyWord:self.keyWord font:kFont(15) highlightedColor:kCommonHighLightRedColor textColor:kBlackColor];
    }
